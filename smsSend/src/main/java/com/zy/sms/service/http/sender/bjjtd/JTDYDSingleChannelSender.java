 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_JTD_YD_CHANNEL001" )
public class JTDYDSingleChannelSender extends JTDChannelFactory
{
	private static final String CHANNEL_NAME = "【聚通達移動(單網)】通道";

	public JTDYDSingleChannelSender()
	{
		super();
	...
	@Value( "${BJ.JTD.YD.SINGLE.USERNAME}" )
	@Override
