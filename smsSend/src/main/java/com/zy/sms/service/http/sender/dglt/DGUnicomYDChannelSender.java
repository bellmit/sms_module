 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "DG_UNICOM_CHANNEL001" )
public class DGUnicomYDChannelSender extends DGUnicomChannelFactory
{
	private static final String CHANNEL_NAME = "【東莞聯通(移動)】通道";

	public DGUnicomYDChannelSender()
	{
		super();
