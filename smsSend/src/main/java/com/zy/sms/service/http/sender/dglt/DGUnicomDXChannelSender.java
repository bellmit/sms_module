 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "DG_UNICOM_CHANNEL002" )
public class DGUnicomDXChannelSender extends DGUnicomChannelFactory
{
	private static final String CHANNEL_NAME = "【東莞聯通(電信)】通道";

	public DGUnicomDXChannelSender()
	{
		super();
