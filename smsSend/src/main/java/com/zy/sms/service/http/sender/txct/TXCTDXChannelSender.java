 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_CT_CHANNEL002" )
public class TXCTDXChannelSender extends TXCTChannelFactory
{
	private static final String CHANNEL_NAME = "【北京天下暢通(電信)】通道";

	public TXCTDXChannelSender()
	{
		super();
