 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "ZS_P2P_CHANNEL002" )
public class ZSp2pDXChannelSender extends ZSp2pChannelFactory
{
	private static final String CHANNEL_NAME = "【中山點對點(電信)】通道";

	public ZSp2pDXChannelSender()
	{
		super();
