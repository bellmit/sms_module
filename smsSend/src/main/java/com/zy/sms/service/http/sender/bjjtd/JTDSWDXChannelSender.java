 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_JTD_YDSW_CHANNEL002" )
public class JTDSWDXChannelSender extends JTDChannelFactory
{
	private static final String CHANNEL_NAME = "【聚通達移動三網(電信)】通道";

	public JTDSWDXChannelSender()
	{
		super();
