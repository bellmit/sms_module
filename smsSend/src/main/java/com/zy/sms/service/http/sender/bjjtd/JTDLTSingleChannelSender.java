 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_JTD_LT_SINGLE_CHANNEL" )
public class JTDLTSingleChannelSender extends JTDChannelFactory
{
	private static final String CHANNEL_NAME = "【聚通達聯通(單網)】通道";

	public JTDLTSingleChannelSender()
	{
		super();
