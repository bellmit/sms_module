 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_JTD_YDSW_CHANNEL001" )
public class JTDSWYDChannelSender extends JTDChannelFactory
{
	private static final String CHANNEL_NAME = "【聚通達移動三網(移動)】通道";

	public JTDSWYDChannelSender()
	{
		super();
