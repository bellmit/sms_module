 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "ZS_P2P_CHANNEL003" )
public class ZSp2pLTChannelSender extends ZSp2pChannelFactory
{
	private static final String CHANNEL_NAME = "【中山點對點(聯通)】通道";

	public ZSp2pLTChannelSender()
	{
		super();
