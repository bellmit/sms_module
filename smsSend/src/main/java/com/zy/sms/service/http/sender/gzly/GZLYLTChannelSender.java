 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "GZ_LY_LT_CHANNEL001" )
public class GZLYLTChannelSender extends GZLYChannelFactroy
{
	private static final String CHANNEL_NAME = "【廣州朗月(聯通)】通道";

	public GZLYLTChannelSender()
	{
		super();
