 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_JTD_YDSW_CHANNEL003" )
public class JTDSWLTChannelSender extends JTDChannelFactory
{
	private static final String CHANNEL_NAME = "【聚通達移動三網(聯通)】通道";

	public JTDSWLTChannelSender()
	{
		super();
