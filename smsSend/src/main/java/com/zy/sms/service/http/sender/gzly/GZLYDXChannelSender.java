 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "GZ_LY_DX_CHANNEL001" )
public class GZLYDXChannelSender extends GZLYChannelFactroy
{
	private static final String CHANNEL_NAME = "【廣州朗月(電信)】通道";

	public GZLYDXChannelSender()
	{
		super();
