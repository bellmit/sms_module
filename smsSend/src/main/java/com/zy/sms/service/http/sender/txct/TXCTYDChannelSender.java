 ...
 * </pre>
 *********************************************************************************************/
@Service( value = "BJ_CT_CHANNEL001" )
public class TXCTYDChannelSender extends TXCTChannelFactory
{
	private static final String CHANNEL_NAME = "【北京天下暢通(移動)】通道";

	public TXCTYDChannelSender()
	{
		super();
