...
/*********************************************************************************************
 * <pre>
 *     FileName: com.zy.sms.service.http.sender.TJSWChannelSenderTest
 *         Desc:
 *       author: Z_Z.W - myhongkongzhen@gmail.com
 *      version: 2015-11-18 15:43
 *   LastChange: 2015-11-18 15:43
 *      History:
 * </pre>
 *********************************************************************************************/
@RunWith( SpringJUnit4ClassRunner.class )
@ContextConfiguration( locations = { "classpath:spring/spring.xml" } )
public class TJSWChannelSenderTest
{
...
//			for ( int i = 0 ; i < 3000 ; i++ )
			{
				...
				smsSendDataInfo.setCarriers( "YD" );
				smsSendDataInfo.setTemplateId( "1" );
				smsSendDataInfo.setSmsid( StringUtils.substring( UUID.randomUUID().toString().replace( "-", "" ), 1, 20 ) );
				smsSendDataInfo.setUuid( StringUtils.substring( UUID.randomUUID().toString().replace( "-", "" ), 1, 20 ) );
	...
	@Resource( name = "TJ_COMM_CHANNEL001" )
